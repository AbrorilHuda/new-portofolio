            ...
            >
                ...
                <div class="flex gap-3 pt-2 flex-wrap border-t border-gray-200 dark:border-gray-800">
                    <button
                        type="submit"
                        disabled={!image}
                        class="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md font-medium transition-colors text-sm disabled:opacity-60 disabled:cursor-not-allowed mt-4"
                    >
                        {editingItem ? "Simpan Perubahan" : "Tambah Project"}
                    </button>
                    <button
                        type="button"
                        on:click={cancelForm}
