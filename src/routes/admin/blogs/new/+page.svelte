<script lang="ts">
  ...
  let title_en = form?.title_en || '';
  let slug = form?.slug || '';
  let content = form?.content || '';
  let content_en = form?.content_en || '';
  let excerpt = form?.excerpt || '';
  let excerpt_en = form?.excerpt_en || '';
...
Tulis artikel berkualitas di sini...
    ...
    <div class="flex items-center gap-3">
      ...
      <div>
        <div class="flex items-center gap-2 text-xs font-semibold text-zinc-400">
          ...
          <span>Articles</span>
          <span>/</span>
          <span class="text-blue-600 dark:text-blue-400">New</span>
        </div>
        <h1 class="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">Buat Artikel Baru</h1>
      </div>
    </div>
