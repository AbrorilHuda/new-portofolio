...
<div class="container mx-auto px-4 py-16 max-w-4xl">
  <article itemscope itemtype="https://schema.org/BlogPosting">
    <a
      href="/blog"
      class="inline-flex items-center text-blue-600 hover:underline mb-8 p-2"
    >
    ...
    <!-- Header -->
    <header class="mb-8">
      <h1 itemprop="headline" class="text-4xl md:text-5xl font-bold mb-4">
        {data.blog.title}
      </h1>
      ...
      {#if data.blog.excerpt}
        <p
          ...
          class="text-xl text-gray-600 dark:text-gray-400 mt-4"
        >
          {data.blog.excerpt}
        </p>
      {/if}
    ...
    <div class="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
      <div
        class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-6 border border-blue-100 dark:border-gray-600"
      >
        <h3
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
          ...
          >
            ...
            {:else}
              <svg
                ...
                stroke-width="2"
                stroke="currentColor"
                class="w-6 h-6 text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors"
              >
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
              ...
              <span
                class="text-xs font-medium text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors"
                >{t($locale, "blog.copyLink")}</span
              >
            {/if}
          </button>
          ...
          <a
            href="https://twitter.com/intent/tweet?url={encodeURIComponent(
              canonicalUrl,
            )}&text={encodeURIComponent(data.blog.title)}"
            target="_blank"
          ...
          >
            ...
            <span
              class="text-xs font-medium text-gray-600 dark:text-gray-400 group-hover:text-[#1DA1F2] transition-colors"
              >Twitter</span
            >
          </a>
          ...
          >
            ...
            <span
              class="text-xs font-medium text-gray-600 dark:text-gray-400 group-hover:text-[#1877F2] transition-colors"
              >Facebook</span
            >
          </a>
          ...
          >
            ...
            <span
              class="text-xs font-medium text-gray-600 dark:text-gray-400 group-hover:text-[#0A66C2] transition-colors"
              >LinkedIn</span
            >
          </a>
          ...
          >
            ...
            <span
              class="text-xs font-medium text-gray-600 dark:text-gray-400 group-hover:text-[#25D366] transition-colors"
              >WhatsApp</span
            >
          </a>
        </div>
