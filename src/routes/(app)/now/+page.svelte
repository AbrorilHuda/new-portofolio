        ...
        >
            ...
            >
                ...
                {#if totalGithubRepos !== null}
                    <div
                        class="px-3 py-1 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-sm font-semibold rounded-full border border-blue-100 dark:border-blue-500/20 shadow-xs flex items-center gap-2"
                    >
                        <span
