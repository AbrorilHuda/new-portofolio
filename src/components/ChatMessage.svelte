    ...
    const aiKnowledge = {
        ...
        projects: [
            {
                name: "Demtimcod Docs",
                description:
                    "Documentation platform built with React and Docusaurus",
            ...
            },
            {
                name: "DCN UNIRA",
                description:
                    "Dicoding Community Network hub for Universitas Madura",
        ...
        experience: [
            ...
            },
            {
                ...
                description:
                    "Teaching assistant for Operating Systems practicum",
            },
        ],
            ...
            <div class="ai-header">
                ...
                <div class="header-controls">
                    ...
                    {#if availableVoices.length > 1}
                        <button
                            class="header-voice-toggle {showVoiceSettings
                                ? 'active'
                                : ''}"
                            on:click={() =>
                ...
                <div class="voice-settings-overlay">
                    ...
                    <div class="voice-list">
                        {#each availableVoices as voice}
                            <button
                                class="voice-option {selectedVoice?.name ===
                                voice.name
                                    ? 'active'
                                    : ''}"
                                on:click={() => {
            ...
            <div class="input-area">
                <div class="quick-questions">
                    ...
                    <button
                        ...
                        on:click={() => {
                            newMessage =
                                "Proyek apa saja yang pernah dia kerjakan?";
                            handleSend();
                        }}
                    >
                        🚀 Proyek
