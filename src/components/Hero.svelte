    ...
    onMount(async () => {
        try {
            ...
            if (res.ok) {
                ...
                if (data.total_public_repos) {
                    totalRepos = `${data.total_public_repos}+`;
                }
            }
        } catch (e) {
            console.error("Failed to load repo count", e);
        }
    });
</script>
...
<section
    id="hero"
    class="min-h-screen flex items-center justify-center px-6 lg:px-8 pt-20 relative overflow-hidden"
>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8">
                ...
                >
                    ...
                    <div>
                        ...
                        <p
                            class="text-[11px] sm:text-xs text-gray-500 dark:text-gray-400 font-semibold uppercase tracking-wider"
                        >
                            {$locale === "en" ? "Public Repos" : "Repo Publik"}
                        </p>
                    </div>
                    <div>
                        <p
                ...
                <div class="flex flex-wrap gap-4 fade-in-up delay-300">
                    ...
                    >
                        <span class="relative z-10"
                            >{t($locale, "hero.viewProjects")}</span
                        >
                        <div
                ...
                <div class="flex gap-3 sm:gap-4 fade-in-up delay-400 pb-3">
                    <a
                        ...
                        class="p-3 sm:p-4 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all hover:scale-110 hover:-translate-y-1 active:scale-95"
                        aria-label="GitHub"
                    >
                        <svg
            ...
            <div class="relative fade-in-up delay-200">
                <div class="relative w-full aspect-square max-w-md mx-auto">
                    ...
                    <div
                        class="absolute -top-4 -left-4 w-24 h-24 bg-blue-600/20 rounded-full blur-2xl animate-float"
                    ></div>
                    <div
                        class="absolute -bottom-4 -right-4 w-32 h-32 bg-purple-600/20 rounded-full blur-2xl animate-float"
